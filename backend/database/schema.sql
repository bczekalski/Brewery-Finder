...
INSERT INTO reviews (review_id, reviewer_name, review_title, review_text, review_stars, review_type, user_id, target_id) VALUES
(1, 'Brandon Czekalski', 'I love this place', 'Hitchhiker is a really cool brewery.', 4, 'Brewery', 4, 9),
(2, 'Brandon Czekalski', 'This place is okay', 'Eleventh Hour has really interesting beers, but the atmosphere in the tap room sucks.', 3, 'Brewery', 4, 1),
(3, 'Brandon Czekalski', 'Amazing place', 'Church Brew has a really cool design. The beer is good too.', 5, 'Brewery', 4, 6),
(4, 'Celeste', 'Worst service ever', 'Church Brew sucks.', 1, 'Brewery', 5, 10),
(5, 'Brandon Czekalski', 'Do not recommend', 'Cosmic Void tastes okay.', 2, 'Beer', 4, 3),
